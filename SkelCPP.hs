...
transDef x = case x of
  ...
  AbsCPP.DInline type_ id args stms -> failure x
...
transStm x = case x of
  ...
  AbsCPP.SternarySimple exp stm -> failure x
  AbsCPP.SternaryComplete exp1 exp2 stm -> failure x
...
transExp x = case x of
  ...
  AbsCPP.Eidx id exp -> failure x
  AbsCPP.Edot exp1 exp2 -> failure x
  ...
  AbsCPP.EShiftLeft exp1 exp2 -> failure x
  AbsCPP.EShifRight exp1 exp2 -> failure x
