...
instance Print AbsCPP.Def where
  prt i = \case
    ...
    AbsCPP.DInline type_ id_ args stms -> prPrec i 0 (concatD [doc (showString "inline"), prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "{"), prt 0 stms, doc (showString "}")])
...
instance Print AbsCPP.Stm where
  prt i = \case
    ...
    AbsCPP.SternarySimple exp stm -> prPrec i 0 (concatD [prt 0 exp, doc (showString "?"), prt 0 stm])
    AbsCPP.SternaryComplete exp1 exp2 stm -> prPrec i 0 (concatD [prt 0 exp1, doc (showString "?"), prt 0 exp2, doc (showString ":"), prt 0 stm])
...
instance Print AbsCPP.Exp where
  prt i = \case
    ...
    AbsCPP.Eidx id_ exp -> prPrec i 15 (concatD [prt 0 id_, doc (showString "["), prt 0 exp, doc (showString "]")])
    ...
    AbsCPP.EShiftLeft exp1 exp2 -> prPrec i 10 (concatD [prt 10 exp1, doc (showString "<<"), prt 11 exp2])
    AbsCPP.EShifRight exp1 exp2 -> prPrec i 10 (concatD [prt 10 exp1, doc (showString ">>"), prt 11 exp2])
