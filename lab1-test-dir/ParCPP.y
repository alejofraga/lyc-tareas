...
Def
  ...
  | 'inline' Type Id '(' ListArg ')' '{' ListStm '}' { AbsCPP.DInline $2 $3 $5 $8 }
...
Stm
  ...
  | Exp '?' Stm { AbsCPP.SternarySimple $1 $3 }
  | Exp '?' Exp ':' Stm { AbsCPP.SternaryComplete $1 $3 $5 }
...
Exp10 :: { AbsCPP.Exp }
Exp10
  : Exp10 '<<' Exp11 { AbsCPP.EShiftLeft $1 $3 }
  | Exp10 '>>' Exp11 { AbsCPP.EShifRight $1 $3 }
  | Exp11 { $1 }
